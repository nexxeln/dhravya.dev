...
summary: 'Join me on my journey of learning to make a CLI and make API requests in Rust'
date: 2022-03-02
tags: ['terminal', 'rust']
draft: false
topic: project
...
Rust is difficult. And like any difficult thing, I realized that the best way to learn is by getting my hands dirty and doing _some_ project so that I can start learning and creating **useful** things that people can use in their everyday lives
...
I decided to go only with QR code for now, because I’m just a beginner at rust, and let’s be honest, no one is _actually_ going to use the cli, it’s more of a learning experience.

...
summary: 'I have more than 40 python projects, managing was getting difficult, so I made pyre, a python project management tool.'
date: 2022-04-11
tags: ['rust', 'python', 'productivity', 'showdev']
ogImage: /static/images/pyre.png
draft: false
topic: project
---

<img
  src='https://github.com/Dhravya/pyre/blob/11b56eee3ead32e104079638dade03f4b62a36d0/logo.png?raw=true'
  alt='Pyre Logo'
  align='left'
  height='150'
  width='150'
...
- Pip install isn't _interactive_ i mean, it just prints the output _after_ installation is done

...
summary: 'How I set up a newsletter using Revue, and why I love it'
date: 2022-03-01
tags: ['newsletter']
draft: false
topic: experience
...
Then, I noticed that I can also send "Issues" using my own EMAIL! I use Cloudflare emails, which, by the way, I LOVE doing. It's the ultimate flex for me haha Anyways, apparently I just had to do this ![setup](https://us-east-1.tixte.net/uploads/img.dhravya.dev/l073vf9kz0a.png) and verify the email address, it worked like a charm!
...
I've also integrated this blog's RSS feed to the newsletter, let's see how that goes!!!! This blog was actually just supposed to be the test blog lmfao ![image](https://us-east-1.tixte.net/uploads/img.dhravya.dev/l07405pa90a.png)
